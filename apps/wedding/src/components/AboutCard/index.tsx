      ...
      <div className={styles.about}>
        ...
        <div className="text-size-xl leading-loose">
          <p>
            ...
            when Steven approached her to say, “Hi, I’m Steven.” He looked just
            like Obama, so Ariana was smitten, and they danced into the night.
            The two exchanged information and, the next day, Steven asked Ariana
            to have dinner (their first date). Being together felt like home,
            although they were practically strangers. Ariana had to leave
            Williamsburg (as she was only visiting), but Steven and Ariana
            continued conversing over the next several months.
          </p>
          <p>
            ...
            Virginia in 2018; adopted a beautiful, loving pup named Domino; and
            bought a house.
          </p>
          <p>
